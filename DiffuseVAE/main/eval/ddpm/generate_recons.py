...
def generate_recons(config):
    ...
    # Load pretrained VAE
    # TODO: incorporate beta VAE into pipeline + wrapper
    vae = None
    ...
    # Dataset
    # TODO: similar to training dataset, just take x_0 images, vae will reconstruct downstream
    # taken care of in utils.py
