...
def sample(config, img_seq):
    ...
    # )
    # root = '/data/yardengoraly/final_project_data/reconstructions/reconstructions-40-better/'
    root = img_seq
    d_type = 'movi-recons-single'
    image_size = 128
    z_dataset = get_dataset(
        d_type,
        root,
        image_size,
        norm=False,
    ...
    recons = trainer.predict(ddpm_wrapper, val_loader)
    return recons
