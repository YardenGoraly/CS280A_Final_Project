# # Generated Movi (Form-1) TODO: fix filepaths + yaml file, training.type=[uncond, form1, form2]
python main/train_ddpm.py +dataset=movi/train \
                     dataset.ddpm.data.root=\'/data/yardengoraly/final_project_data/npz_datasets/movi_c_79935_seq_with_gt_seg_npz/train/\' \
                     dataset.ddpm.data.name='movi' \
                     ...
                     dataset.ddpm.training.vae_chkpt_path=\'no_checkpoint_path\' \
                     dataset.ddpm.training.device=\'gpu:1\' \
                     dataset.ddpm.training.results_dir=\'/home/leohuang/data/diffuseVAE_movi_c_79935_results_uncond\' \
                     dataset.ddpm.training.workers=4 \
                     dataset.ddpm.training.chkpt_prefix=\'movi_uncond_nheads=8_dropout=0.3\'

                    #  dataset.ddpm.data.root=\'/data/yardengoraly/final_project_data/npz_datasets/movi_80000_seq_npz/train/\' \
