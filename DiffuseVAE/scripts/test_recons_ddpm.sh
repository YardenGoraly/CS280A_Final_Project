python main/eval/ddpm/generate_recons.py +dataset=movi/test \
                        dataset.ddpm.data.root='/data/yardengoraly/final_project_data/reconstructions/reconstructions-40/' \
                        dataset.ddpm.data.name='movi-recons' \
                        ...
                        dataset.ddpm.evaluation.chkpt_path=\'/home/leohuang/data/ckpt/ddpmv2-movi_uncond_nheads=8_dropout=0.3-epoch=03-loss=0.0000.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.save_path=\'/home/leohuang/data/diffuseVAE_movi_80000_results_uncond/recons_form1_sample/\' \
                        ...
                        dataset.vae.evaluation.chkpt_path=\'no_checkpoint_path\'
