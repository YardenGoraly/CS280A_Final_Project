python main/eval/ddpm/sample.py +dataset=movi/test \
                        ...
                        dataset.ddpm.evaluation.sample_prefix='real' \
                        dataset.ddpm.evaluation.device=\'gpu:2\' \
                        dataset.ddpm.evaluation.save_mode='image' \
                        dataset.ddpm.evaluation.chkpt_path=\'/home/leohuang/data/ckpt/ddpmv2-movi_uncond_nheads=8_dropout=0.3-epoch=05-loss=0.0000.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.save_path=\'/home/leohuang/data/diffuseVAE_movi_c_79935_results_uncond/uncond_recons/\' \
