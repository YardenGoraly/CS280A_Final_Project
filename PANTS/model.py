...
class SOCS(LightningModule):
    ...
    def decode_latents(self, data, slot_tokens, latent_offset=0, eval=False):
        output = {}
        ...
        if eval:
            ...
            object_latent_mean[0, :, 0] += latent_offset
    ...
    def training_step(self, batch, batch_idx):
        ...
        if 'mask_loss' in output.keys():
            mask_loss_param = 0.00005*np.log(1 + (batch_idx + self.current_epoch*10000))
